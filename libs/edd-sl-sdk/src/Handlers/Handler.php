...
abstract class Handler {
	...
	public function ajax_get_license_overlay() {
		...
		// Wbcom guard: SDK 1.0.3 passed this value straight to Templates::load(), which
		// includes "{templates}/{value}.php" - an authenticated local file inclusion.
		// Only the one shipped template is allowed, and only for administrators.
		if ( 'license-control' !== $template || ! current_user_can( 'manage_options' ) ) {
