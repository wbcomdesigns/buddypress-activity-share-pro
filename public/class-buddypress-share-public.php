					...
					<div class="modal-header-content">
						<div class="quick-post-header-filters-wrap">
							<div class="bp-activity-share-avatar">
								...
								<small class="bp_activity_share_modal_error_message" style="display: none; color: #dc3545;"><?php esc_html_e( 'Please select where to post this activity.', 'buddypress-share' ); ?></small>
							</div>
