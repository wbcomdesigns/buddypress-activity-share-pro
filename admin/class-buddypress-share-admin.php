...
class Buddypress_Share_Admin {
	...
	public function bpas_reshare_setting_section() {
		...
		$bp_reshare_settings_values                    = isset( $bp_reshare_settings['reshare_share_activity'] ) ? $bp_reshare_settings['reshare_share_activity'] : 'parent';
		?>
		<div class="wbcom-tab-content">
			<div class="wbcom-wrapper-admin">
				<div class="wbcom-admin-title-section">
							...
							<div class="wbcom-settings-section-wrap">
								...
								<div class="wbcom-settings-section-options">
									<ul>
										<li>
											<label>
												<input type="radio" name="bp_reshare_settings[reshare_share_activity]" value="parent" <?php checked( 'parent', $bp_reshare_settings_values ); ?> />&nbsp;<?php esc_html_e( 'Parent', 'buddypress-share' ); ?>
											</label>
										</li>
										<li>
											<label>
												<input type="radio" name="bp_reshare_settings[reshare_share_activity]" value="child" <?php checked( 'child', $bp_reshare_settings_values ); ?> />&nbsp;<?php esc_html_e( 'Child', 'buddypress-share' ); ?>
											</label>
										</li>									
									</ul>	
								</div>
