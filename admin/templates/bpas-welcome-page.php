			...
			<div class="wbcom-welcome-support-info">
				...
				<div class="wbcom-support-info-wrap">
					<div class="wbcom-support-info-widgets">
						...
						<a href="<?php echo esc_url( 'https://docs.wbcomdesigns.com/docs/buddyx-theme/buddyx-pro-modules/buddypress-activity-share-pro/' ); ?>" class="button button-primary button-welcome-support" target="_blank"><?php esc_html_e( 'Read Documentation', 'buddypress-share' ); ?></a>
						</div>
					</div>
